    ...
    <%@taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
        ...
        <body>
            ...
            <div
                ...
                <form:form action="tutorRegistration.htm" method="POST" modelAttribute="tutor">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <label class="form-label" for="SelectSubject">Select Subject:</label>
                    ...
                    <form:hidden path="role" value="Tutor" />
